...
const DB_REGISTRY = [
  {
    ...
    columns: [
      ...
      { key: 'pickup_day',     label: 'Pickup Day',   sortable: true  },
    ...
    fields: [
      ...
      { key: 'pickup_day',        label: 'Pickup Day',         type: 'select', required: false, options: ['','Monday','Tuesday','Wednesday','Thursday','Friday'] },
